...
public class _RProgressBar extends JProgressBar{
    ...
    private static final int PREFERRED_PERCENT_STRING_MARGIN_WIDTH = 4;

    //Couleur du petit bout à gauche
    ...
    public _RProgressBar() {
        progressColor = PREFERRED_PROGRESS_COLOR;
    }

    public void updateGraphics() {
    	//Dessinez sur un objet dessiné
        update(getGraphics());
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isOpaque()) {
    		...
    		try {
    			iBande = ImageIO.read(new File("Resources/cardio.png"));
    			g.drawImage(iBande, 0, 0,39,39, this);
